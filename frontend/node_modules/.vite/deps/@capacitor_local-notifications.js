import { r as registerPlugin } from "./dist-BgBrx6RR.js";
...
var LocalNotifications = registerPlugin("LocalNotifications", { web: () => import("./web-BB1f5JNW.js").then((m) => new m.LocalNotificationsWeb()) });
//#endregion
